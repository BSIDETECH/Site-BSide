...
export function WebDevelopmentSection() {
  return (
    <section id="sites" className="py-24 bg-theme-bg relative overflow-hidden">
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-theme-accent/10 rounded-full blur-[120px] pointer-events-none -translate-y-1/2"></div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-theme-bg-alt border border-theme-border text-sm font-medium text-theme-accent mb-6">
            Novo Serviço
          </div>
          <h2 className="text-3xl md:text-5xl font-bold mb-6 font-handwriting">
            Presença Digital de Alta Conversão
          </h2>
          <p className="text-lg text-theme-text-muted max-w-3xl mx-auto leading-relaxed">
