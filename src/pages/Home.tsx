      ...
      <header className="fixed w-full top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <a href="#sites" className="text-sm font-medium text-slate-400 hover:text-white transition-colors">Criação de Sites</a>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-slate-900 border-b border-slate-800 px-4 py-6 flex flex-col gap-4">
            ...
            <a href="#sites" onClick={() => setIsMobileMenuOpen(false)} className="text-lg font-medium text-slate-400 hover:text-white">Criação de Sites</a>
